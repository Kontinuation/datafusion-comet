...
| spark.comet.exec.memoryPool | The type of memory pool to be used for Comet native execution. Available memory pool types are 'greedy' and 'fair_spill'. By default, this config is 'fair_spill'. | fair_spill |
