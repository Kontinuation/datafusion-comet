...
| spark.comet.exec.memoryPool | The type of memory pool to be used for Comet native execution. Available memory pool types are 'fair_spill_global', 'fair_spill_shared', 'greedy' and 'fair_spill'. By default, this config is 'fair_spill_shared'. | fair_spill_shared |
